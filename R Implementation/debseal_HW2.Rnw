debseal_HW4 <- function() {
setwd("C:\\DebSeal\\IUB MS Program\\IUB Sem III\\B565 Data Mining\\Assignment 4")
Sweave("debseal_HW2.Rnw")
system(paste("pdflatex --interaction=nonstopmode",  "debseal_HW4.tex"))
